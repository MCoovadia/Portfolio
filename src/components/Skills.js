...
const Skills = () => {
  return (
    <div class="container px-4 py-5 bg-orange-100" id="featured-3">
      <h2 class="pb-2 border-bottom border-dark">Skills</h2>
      <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
        <div class="feature col text-center">
          ...
          <h3 class="fs-2 text-body-emphasis">Front End</h3>
          <div class="container">
            <ul class="list-group">
        ...
        <div class="feature col text-center">
          ...
          <h3 class="fs-2 text-body-emphasis">Frameworks / Back end</h3>
          <div class="container">
            <ul class="list-group">
              <li class="list-group-item">React </li>
              <li class="list-group-item">Bootstrap / Material-UI/ Bulma</li>
              <li class="list-group-item">Google Cloud Platform / Azure</li>
              <li class="list-group-item">SQL / MongoDB</li>
            </ul>
          </div>
        </div>
        <div class="feature col text-center">
          ...
          <div class="container">
            <ul class="list-group">
              ...
              <li class="list-group-item">JMeter </li>
              <li class="list-group-item">Katalon Studio</li>
